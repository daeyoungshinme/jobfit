...
POSITION = EnumSet([
    EnumMember("fullstack", "풀스택 개발자", meta={"terms": ("풀스택",)}),
    EnumMember("android", "안드로이드 개발자", meta={"terms": ("안드로이드", "android")}),
    EnumMember("ios", "iOS 개발자", meta={"terms": ("ios",)}),
    ...
    EnumMember("devops", "DevOps/인프라 엔지니어", meta={"terms": ("devops", "데브옵스", "인프라 엔지니어")}),
    EnumMember("qa", "QA 엔지니어", meta={"terms": ("qa", "품질관리", "품질보증")}),
    EnumMember("backend", "백엔드 개발자", meta={"terms": ("백엔드", "서버 개발자", "backend")}),
    EnumMember("frontend", "프론트엔드 개발자", meta={"terms": ("프론트엔드", "프론트 개발자", "frontend")}),
